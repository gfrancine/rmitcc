...
async function setup() {
  ...
  img = await loadImage("data/background_bg.png");
  ...
  frameRate(10); // I'm running on 20% battery
...
function draw() {
  ...
  if (frameCount % 60 === 0) {
    ...
    let glitchText = ["ERROR", "GLITCH TV", "ERROR", "GL T H T ", "G  T TV"][
      floor(random(0, 5))
    ];
