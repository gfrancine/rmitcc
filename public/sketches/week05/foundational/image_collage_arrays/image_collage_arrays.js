...
async function setup() {
  ...
  // For example, if you have 2 images for each: layer1_0.png, layer1_1.png.
  for (let i = 0; i < 2; i++) {
    layer1Images.push(await loadImage("data/layer1_" + i + ".png"));
    layer2Images.push(await loadImage("data/layer2_" + i + ".png"));
    layer3Images.push(await loadImage("data/layer3_" + i + ".png"));
  }
